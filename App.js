			...
			<UsersProvider>
				<NavigationContainer>
					<Stack.Navigator initialRouteName='Splash'>
						...
						<Stack.Screen name="Desbloqueio"  component={Desbloqueio}  options={{ headerShown: true,  headerStyle: {backgroundColor: estilo.cor.fundo}, headerTintColor: estilo.cor.fonte, headerTitleStyle:{fontWeight: 'bold'}, title: 'Habilitação Provisória' }} />
